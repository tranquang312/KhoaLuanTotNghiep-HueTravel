                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.tours.update', $tour) }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full">{{ old('description', $tour->description) }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('description')" />
                        </div>

                        <div>
                            <x-input-label for="price" :value="__('Giá')" />
                            <x-text-input id="price" name="price" type="number" step="0.01" class="mt-1 block w-full" :value="old('price', $tour->price)" required />
                            <x-input-error class="mt-2" :messages="$errors->get('price')" />
                        </div>

                        <div>
                            <x-input-label for="itinerary" :value="__('Lịch trình')" />
                            <textarea id="itinerary" name="itinerary" class="mt-1 block w-full">{{ old('itinerary', $tour->itinerary) }}</textarea>
