                    ...
                    <form method="POST" action="{{ route('admin.destinations.update', $destination) }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="address" name="address" type="text" class="mt-1 block w-full"
                                :value="old('address', $destination->address)" required />
                        ...
                        <div>
                            ...
                            <textarea id="short_description" name="short_description"
                                ...
                                rows="3" required>{{ old('short_description', $destination->short_description) }}</textarea>
                        ...
                        <div>
                            ...
                            <div id="imagesPreview" class="mt-2 flex flex-wrap gap-2">
                                @foreach ($allImages as $image)
                                    <div class="relative">
                                        <img src="{{ asset('storage/' . $image->image_path) }}"
                                            class="max-w-[120px] max-h-[120px] rounded border">
                                    </div>
                                @endforeach
                            </div>
                ...
                if (input.files) {
                    Array.from(input.files).forEach(file => {
                        ...
                        reader.onload = function(e) {
                            ...
                            img.classList.add('max-w-[120px]', 'max-h-[120px]', 'rounded', 'border');
